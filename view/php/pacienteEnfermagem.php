    ...
    <sidenav class="menu">
      ...
      <div class="topicos">
        <div class="topicosSuperiores">
          ...
          <a href="./pacienteEnfermagem.php" class="icone icone-selecionado">
            <svg
    ...
    <div class="sessao">
      ...
      <div id="container-anamnese" class="abaConteudo sessaoConteudo abaSelecionado ">
        <div class="descricao w50">
          <h3>Possui alguma dor ? Quais são ?</h3>
          <div>
            <p> Sim; dor na cintura, e coxa. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Queixa principal:</h3>
          <div>
            <p> Dores na cintura. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Patologias Pregressas / Cirurgias anteriores</h3>
          <div>
            <p> Nenhuma. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Condições gerais : Medicamentos de Uso Contínuo :</h3>
          <div>
            <p> Nenhum até o momento</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Portador de Marcapasso </h3>
          <div>
            <p> Não</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Faz uso de anticoncepcional? Qual ?</h3>
          <div>
            <p> Não. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Possui filhos? Quantos?</h3>
          <div>
            <p> Sim; 1 filha</p>
          </div>
        ...
        <div class="descricao w50">
          <h3>Sono e Repouso : Em média quantas horas de sono por dia ?</h3>
          <div>
            <p>De 5 a 6 horas. </p>
          </div>
        </div>
