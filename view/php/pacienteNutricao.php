    ...
    <sidenav class="menu">
      ...
      <div class="topicos">
        <div class="topicosSuperiores">
          ...
          <a href="./pacienteNutricao.php" class="icone icone-selecionado">
    ...
    <div class="sessao">
      ...
      <div id="container-anamnese" class="abaConteudo sessaoConteudo abaSelecionado ">
        <div class="descricao w50">
          <h3>Já fez alguma dieta? Se sim, há quanto tempo foi a última?</h3>
          <div>
            <p> Não</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Preferência alimentar:</h3>
          <div>
            <p> Comidas saudaveis. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Quantas refeições faz por dia ?</h3>
          <div>
            <p>3</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Você costuma ter tempo para fazer suas refeições? Se sim, quanto tempo?</h3>
          <div>
            <p> Sim; 30 minutos.</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Faz parte da sua rotina tomar café da manhã todos os dias?</h3>
          <div>
            <p> Sim</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Atualmente segue alguma dieta especial?</h3>
          <div>
            <p> Não. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Quem prepara as refeições?</h3>
          <div>
            <p>Esposa</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Onde realiza as refeições ?</h3>
          <div>
            <p>Em casa, e no trabalho.</p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Seu intestino funciona todos os dias? Qual a frequencia?</h3>
          <div>
            <p>Sim, de 1 em 1 hora.</p>
          </div>
        </div>
      </div>
      <!--containerAnanese-->
