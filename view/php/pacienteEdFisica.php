    ...
    <div class="sessao">
      ...
      <div id="container-anamnese" class="abaConteudo sessaoConteudo abaSelecionado ">
        <div class="descricao w100">
          <h3>Já praticou alguma atividade física no passado ? Quais por quanto tempo ?</h3>
          <div>
            <p> Não praticava nenhuma. </p>
          </div>
        </div>
        <div class="descricao w100">
          <h3>Pratica alguma atividade física atualmente ? Quais e a quanto tempo </h3>
          <div>
            <p>Sim; está fazendo caminhadas durante 5 meses. </p>
          </div>
        </div>
        <div class="descricao w100">
          <h3>Normalmente qual a sua dificuldade para correr, levantar objetos pesados, praticar esportes ou realizar trabalhos pesados ?</h3>
          <div>
            <p> Falta de folego, e dor na cintura. </p>
          </div>
        </div>
        <div class="descricao w100">
          <h3>Normalmente qual a sua dificuldade para abaixar-se, ajoelhar-se ou curvar-se ?</h3>
          <div>
            <p> Dor na cintura. </p>
          </div>
        </div>
        ...
        <div class="descricao w50">
          <h3>Você tem algum problema ósseo ou articular (por exemplo: costas, joelho ou quadril) que possa piorar com a prática de atividades físicas ?</h3>
          <div>
            <p> Sim, cintura. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Você tem algum problema musculoesquelético ? Qual ?</h3>
          <div>
            <p> Sim, dores forte na cintura. </p>
          </div>
        </div>
        <div class="descricao w50">
          <h3>Você perdeu equilíbrio em virtude de tonturas ou perdeu a consciência quando estava praticando atividade física ?</h3>
          <div>
            <p>Não</p>
          </div>
        </div>
